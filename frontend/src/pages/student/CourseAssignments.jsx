  ...
  return (
    <div className="p-6 max-w-5xl mx-auto pb-20">
      ...
      <div className="mb-10 px-4">
        <h1 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight leading-[1.1] mb-2 drop-shadow-sm">
          {courseInfo.title}
        </h1>
      ...
      <div className="mb-12 px-4 text-left">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="text-xl font-black text-gray-900 tracking-tight">Curriculum Roadmap</h3>
            <p className="text-xs text-gray-400 font-bold uppercase tracking-widest mt-0.5">Explore your learning modules below</p>
          </div>
        </div>
             ...
             <div className="flex items-center gap-3">
               <button 
                 ...
                 className={`flex items-center gap-2 px-6 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all shadow-sm active:scale-95 ${
                   progressPercent === 100 && courseInfo?.certificateUrl
