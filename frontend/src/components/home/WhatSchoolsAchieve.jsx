...
export default function AchievementLightGallery() {
  ...
  return (
    <section className="h-screen w-full bg-[#FAF9F6] snap-start flex flex-col items-center justify-center relative overflow-hidden px-6 pt-20">
      ...
      <div className="max-w-7xl w-full h-full max-h-[750px] grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
